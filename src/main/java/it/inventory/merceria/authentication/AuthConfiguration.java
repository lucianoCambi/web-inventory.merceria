package it.inventory.merceria.authentication;
...
import static it.inventory.merceria.model.Credentials.ADMIN_ROLE;
import static it.inventory.merceria.model.Credentials.DEFAULT_ROLE;
...
public class AuthConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers(HttpMethod.GET, "/default/**").hasAnyAuthority(DEFAULT_ROLE, ADMIN_ROLE) //admin puo fare anche le cose di default
		.antMatchers(HttpMethod.POST, "/default/**").hasAnyAuthority(DEFAULT_ROLE, ADMIN_ROLE)
